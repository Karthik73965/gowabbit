...
export default function BrandHeroLeft({}: Props) {
  return (
    <>
    <main className="flex ml-[3vw] ">
    <section className="md:w-[8vw] w-[30vw] mr-3 mt-[55vh]">
            ...
            <section className="grid -rotate-90">
                ...
                <div className="w-[250px]  h-[200px] text-xl mt-14 ml-[1vw] bg-black bg-black border-t-2 border-l-4  border-whitek  "> &nbsp;  </div>
