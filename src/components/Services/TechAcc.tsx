  ...
  return (
    <Accordion type="single" collapsible className="w-full mt-[13vw] md:ml-[15vw]  mr-10">
      <AccordionItem className={` border-t border-gray-200 ${click == "website" ? "bg-black text-white" : ""} px-5`} value="item-1">
        <AccordionTrigger onClick={() => Setclick("website")}><span className={`text-3xl py-4  font-thin ${click == "website" ? "bg-black text-white" : ""}`}>WEBSITE DESIGNING</span></AccordionTrigger>
      ...
      <AccordionItem className={`${click == "Search" ? "bg-black text-white" : ""} px-5`} value="item-2">
        <AccordionTrigger onClick={() => Setclick("Search")}><span className={`text-2xl py-4  font-thin ${click == "Search" ? "bg-black text-white" : ""}`}>SEARCH ENGINE OPTIMIZATION</span></AccordionTrigger>
        <AccordionContent className="pl-10">
         <div className="flex">
         LOREM IPSUM Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Porttitor rhoncus dolor purus non enim. Posuere urna nec tincidunt praesent. Porta lorem mollis aliquam ut porttitor leo a diam sollicitudin. Dui accumsan sit amet nulla facilisi.
         <div className="flex w-[30vw] border-2 border-white gap--2 h-[30px] px-2 py-1 rounded-full">
      ...
      <AccordionTrigger onClick={() => Setclick("2D")}><span className={`text-3xl py-4  font-thin ${click == "2D" ? "bg-black text-white" : ""}`}>2D & 3D ILLUSTRATIONS</span></AccordionTrigger>     <AccordionContent className="pl-10">
         <div className="flex">
         LOREM IPSUM Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Porttitor rhoncus dolor purus non enim. Posuere urna nec tincidunt praesent. Porta lorem mollis aliquam ut porttitor leo a diam sollicitudin. Dui accumsan sit amet nulla facilisi.
         <div className="flex w-[30vw] border-2 border-white gap--2 h-[30px] px-2 py-1 rounded-full">
          CHOOSE PRODUCT  <MdOutlineArrowOutward size={20} />
      ...
      <AccordionTrigger onClick={() => Setclick("STOCK")}><span className={`text-3xl py-4  font-thin ${click == "STOCK" ? "bg-black text-white" : ""}`}> STOCK PHOTOGRAPHY </span></AccordionTrigger>
        <AccordionContent className="pl-10">
         <div className="flex">
         LOREM IPSUM Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Porttitor rhoncus dolor purus non enim. Posuere urna nec tincidunt praesent. Porta lorem mollis aliquam ut porttitor leo a diam sollicitudin. Dui accumsan sit amet nulla facilisi.
         <div className="flex w-[30vw] border-2 border-white gap--2 h-[30px] px-2 py-1 rounded-full">
